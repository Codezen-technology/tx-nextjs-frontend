...
export const endpoints = {
  ...
  business: {
    ...
    systemType: `${b2b}/business/system-type`,
    switchSystem: `${b2b}/business/switch-system`,
    creditTransactions: `${b2b}/credits/transactions`,
    creditDiscountTiers: `${b2b}/credits/discount-tiers`,
    creditProduct: `${b2b}/credits/product`,
    creditPurchase: `${b2b}/credits/purchase`,
