...
export function SupportSuccess() {
  return (
    <div className="rounded-xl border border-green-200 bg-green-50 p-8">
      <h2 className="font-suse text-2xl font-bold text-neutral-900">Request received</h2>
        ...
        <ol className="mt-4 space-y-4">
          {[
            ...
            <li key={step} className="flex gap-3 font-open-sans text-sm text-neutral-600">
              <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-secondary-500 font-suse text-sm font-bold text-white">
                {i + 1}
              </span>
              {step}
            </li>
