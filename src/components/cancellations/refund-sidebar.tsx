    ...
    <aside className={cn("space-y-6", className)}>
      <SidebarPanel label="Before you submit">
        ...
        <Link
          ...
          className="mt-4 inline-flex items-center rounded-full border border-primary-200 bg-primary-50 px-4 py-2 font-open-sans text-sm font-semibold text-primary-700 transition-colors hover:bg-primary-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 focus-visible:ring-offset-2"
        >
          Get help →
        </Link>
      </SidebarPanel>
