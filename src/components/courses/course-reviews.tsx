        ...
        <div className="min-w-0 flex-1">
          ...
          {isLong ? (
            <button
              ...
              className="text-secondary-500 mt-1 text-xs font-medium hover:underline"
            >
...
export function CourseReviews({ courseId }: CourseReviewsProps) {
  ...
  if (!data) return <p className="text-muted-foreground text-sm">Unable to load reviews.</p>;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-6 sm:flex-row">
        <div className="border-neutral-30 flex shrink-0 flex-col items-center justify-center gap-1 rounded-xl border bg-white px-8 py-6 shadow-xs">
        ...
        <div className="border-neutral-30 flex-1 space-y-2 rounded-xl border bg-white p-5 shadow-xs">
      ...
      {reviews.length > INITIAL_SHOW && !showAll ? (
        <div className="text-center">
          <button
            ...
            className="border-secondary-500 text-secondary-500 hover:bg-secondary-50 rounded-full border px-6 py-2 text-sm font-medium transition-colors"
          >
