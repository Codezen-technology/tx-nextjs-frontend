...
| ------------------ | --------------------- | ----- | ---- | ------- | ------------------------------------ |
| Homepage           | `/`                   | AMBER | 0    | 4       | `qa-homepage-remaining-rows`         |
...
_Empty — `A6` and `A7` closed by the Homepage remainder slice; `A5` carries no test while it is blocked, and gets one when design rules which face the `£` takes._
...
different pound signs and no measurement can pick the face. Full evidence in
`.context/figma/targets.md`. `QA-HOME-E3` was filed on 2026-08-12 but never added here —
the ledger said seven while the issue tables held eight.
